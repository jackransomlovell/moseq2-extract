...
def extract_options(function):
    ...
    function = click.option('--otsu-dilate-shape', default='elipse', type=str, help='Struct. Ele. shape to perform dilation on binary otsu mask')(function)
    ...
    function = click.option('--use-bilat', default=False, type=bool, help='Bool to indicate use of bilateral filter in otsu step')(function)
